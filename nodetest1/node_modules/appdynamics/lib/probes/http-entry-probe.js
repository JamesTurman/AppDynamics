  ...
  if (!transaction.error) {
    ...
    if (statusCodeConfig) {
      ...
      if (resEndArgs && contentType && contentType.indexOf("utf-8") > -1) {
        transaction.error = {message: "Error code: " + transaction.statusCode + ", " + resEndArgs[0].toString("utf8"), name: "Error"};
      } else {
        transaction.error = {message: "Error code, " + transaction.statusCode + ", no further details", name: "Error"};
      }
    }
  }
