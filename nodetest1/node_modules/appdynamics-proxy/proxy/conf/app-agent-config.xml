<app-agent-configuration>
    ...
    <sensitive-url-filters>
        <!--
            ...
            There can only be one sensitive-url-filter. Each sensitive-url-filter element must have two attributes:

                - delimiter: Characters used to split the url, usually a slash.
    ...
    <agent-services>
        ...
        <agent-service name="DerivedMetricService" enabled="true">
             <configuration>
                 <derived-metric name="JVM|Memory:Heap|Custom Current Usage Percentage"
                                 time-rollup="AVERAGE"
                                 cluster-rollup="INDIVIDUAL"
                                 hole-handling-type="REGULAR_COUNTER">
                     <multiply>
                         <divide>
                             <metric name="JVM|Memory:Heap|Current Usage (MB)"/>
                             <metric name="JVM|Memory:Heap|Max Available (MB)"/>
                         </divide>
                         <static value="10000"/>
                     </multiply>
                 </derived-metric>
